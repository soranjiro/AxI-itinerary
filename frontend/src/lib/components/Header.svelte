			...
			<div class="flex items-center gap-4">
				...
				{:else}
					<button
						...
						class="px-4 py-2 rounded-lg font-medium bg-gradient-primary text-primary-text border-0 cursor-pointer transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary"
					>
						ログイン
					</button>
				{/if}
